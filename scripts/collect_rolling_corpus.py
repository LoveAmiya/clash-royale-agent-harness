...
def collect(mode: str, *, data_dir: Path, batch_id: str | None = None) -> dict:
    ...
    try:
        ...
        try:
            ...
            with stage_heartbeat("importing", status="processing", resolved_batch_id=resolved_batch_id):
            ...
            with stage_heartbeat("validating", status="processing", resolved_batch_id=resolved_batch_id):
            ...
            with stage_heartbeat("retention", status="processing", resolved_batch_id=resolved_batch_id):
            ...
            with stage_heartbeat("publishing", status="processing", resolved_batch_id=resolved_batch_id):
