...
_TEST_ARTIFACTS = tempfile.TemporaryDirectory(prefix="clashroyale_agent_tests_")
_TRACE_TEST_DIR = Path(_TEST_ARTIFACTS.name)
os.environ["CR_AGENT_TRACE_LOG_PATH"] = str(_TRACE_TEST_DIR / "traces.jsonl")
os.environ["FEEDBACK_DB_FILE"] = str(_TRACE_TEST_DIR / "feedback.sqlite3")
os.environ["RAG_QUALITY_REPORT_DIR"] = str(_TRACE_TEST_DIR / "rag_quality")
os.environ["CR_AGENT_QDRANT_ROOT"] = str(_TRACE_TEST_DIR / "daily_snapshot_qdrant")
