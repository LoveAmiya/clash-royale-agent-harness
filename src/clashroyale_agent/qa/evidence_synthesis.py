...
from clashroyale_agent.qa.retrieval_orchestration import (
    RetrievalConfig,
    retrieve_meta_candidates as _retrieve_meta_candidates,
    summarize_retrieval as default_summarize_retrieval,
)
from clashroyale_agent.qa.reviewer_models import (
    ReviewerModelConfig,
    build_reviewer_model as _build_reviewer_model,
)
...
def default_build_reviewer_model(api_key: str) -> OpenAIChatModel | OpenAIResponseModel:
    return _build_reviewer_model(
        api_key,
...
def default_retrieve_meta_candidates(
    retriever: Any,
    query: str,
    *,
    ...
    return _retrieve_meta_candidates(
        retriever,
        query,
...
async def default_stream_with_first_token_watchdog(
    stream,
    *,
    event_sink: Any,
    step_id: str,
